...
const headers = ref([
    ...
    { title: '项目名称', value: 'project_name', fixed: 'start', width: 100 },
    { title: '经手人', value: 'optioner', fixed: 'start', minWidth: 80 },
    { title: '操作金额', value: 'option_money', minWidth: 60 },
    { title: '操作时间', value: 'option_time', minWidth: 150 },
    { title: '操作人', value: 'optioner', minWidth: 80 },
    { title: '银行卡姓名', value: 'card_name', minWidth: 80 },
    { title: '卡类型', value: 'card_type', minWidth: 80 },
    { title: '操作前金额', value: 'befor_opton_money', minWidth: 60 },
    { title: '剩余金额', value: 'left_money', minWidth: 60 },
    { title: '工作日', value: 'working_date', minWidth: 100 },
    { title: '备注', value: 'remark', minWidth: 100 },

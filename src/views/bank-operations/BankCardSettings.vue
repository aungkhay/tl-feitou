...
const headers = ref([
    ...
    { title: '卡类型', value: 'card_type', fixed: 'start', width: 80 },
    { title: '姓名', value: 'card_name', fixed: 'start', minWidth: 80 },
    { title: '卡号', value: 'card_code', minWidth: 150 },
    { title: '初始金额', value: 'initial_amount', minWidth: 60 },
    { title: '初始办公金额', value: 'initial_office_amount', minWidth: 60 },
    { title: '上分金额', value: 'bonus_amount', minWidth: 60 },
    { title: '下分金额', value: 'deduction_amount', minWidth: 60 },
    { title: '转入金额', value: 'transfer_in_amount', minWidth: 60 },
    { title: '转出金额', value: 'transfer_out_amount', minWidth: 60 },
    { title: '手续费', value: 'handling_fee', minWidth: 60 },
    { title: '剩余金额', value: 'remaining_amount', minWidth: 60 },
    { title: '办公金额', value: 'office_amount', minWidth: 60 },
    { title: '卡状态', value: 'card_status', minWidth: 80 },

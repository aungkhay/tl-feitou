...
const headers = ref([
    ...
    { title: '个庄', value: 'g_z', minWidth: 60 },
    ...
    { title: '上盘', value: 'sp', minWidth: 60 },
    { title: '上盘买', value: 'spm', minWidth: 60 },
    { title: '结果', value: 'kj', minWidth: 100 },
    { title: '开奖时间', value: 'stime', minWidth: 150 },
    { title: '总赢亏', value: 'zyk', minWidth: 80 },
    { title: '庄闲赢亏', value: 'xzyk', minWidth: 60 },
    { title: '个赢亏', value: 'gyk', minWidth: 60 },
    { title: '对冲赢亏', value: 'dcyk', minWidth: 60 },
    { title: '闲庄台赢亏', value: 'xztyk', minWidth: 80 },
    { title: 'n宝台嬴亏', value: 'sbltyk', minWidth: 80 },
